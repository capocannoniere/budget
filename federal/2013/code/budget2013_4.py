...
class JsonEncoder_Budget2013_4(json.JSONEncoder):
	def default(self, o):
		return {
			"caption": o.caption,
			"header": o.header,
...
if __name__ == "__main__":
	...
	if output_json_file_name:
		write_json_document(document, output_json_file_name, JsonEncoder_Budget2013_4)
	if output_json_pretty_file_name:
		write_json_pretty_document(document, output_json_pretty_file_name, JsonEncoder_Budget2013_4)
